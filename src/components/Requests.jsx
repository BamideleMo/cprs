    ...
    <>
      <div class="mt-12 sm:mt-24">
        ...
        <div class="mx-4 space-y-4">
          <div class="border border-gray-300 bg-gray-50 p-3 rounded-lg hover:bg-purple-100 cursor-pointer">
            <span class="text-gray-600">2 days ago by 200 level student:</span>
            <br />I am looking for 1 room self contained around the main gate.
          </div>
          <div class="border border-gray-300 bg-gray-50 p-3 rounded-lg hover:bg-purple-100 cursor-pointer">
            <span class="text-gray-600">23 days ago by 400 level student:</span>
            <br />
            In need of room anywhere around the school back gate please. It is
            very urgent.
          </div>
          <div class="border border-gray-300 bg-gray-50 p-3 rounded-lg hover:bg-purple-100 cursor-pointer">
            <span class="text-gray-600">29 days ago by 500 level student:</span>
            <br />
