          ...
          <div class="flex">
            <div class="grow">
              <input
                ...
                type="password"
                id={props.passId}
                class="text-slate-800 w-full block border border-black outline-none bg-white mt-0 px-2 h-12 placeholder:text-slate-400"
              />
            </div>
            <div class="w-12 bg-black border border-black text-center pt-2.5">
              <span
                id="toggleEye"
                onClick={() => {
